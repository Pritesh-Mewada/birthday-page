    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 900, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: typeof window !== 'undefined' && window.innerWidth < 600 ? 8 : 0 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontSize: typeof window !== 'undefined' && window.innerWidth < 600 ? 28 : 64, background: "#fff", color: "#333", borderRadius: 8, padding: typeof window !== 'undefined' && window.innerWidth < 600 ? '0 8px' : '0 24px', minWidth: typeof window !== 'undefined' && window.innerWidth < 600 ? 40 : 90, textAlign: "center", fontFamily: "monospace", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>{time.years}</div>
            <div style={{ color: "#fff", marginTop: 8, fontSize: 20 }}>Years</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontSize: typeof window !== 'undefined' && window.innerWidth < 600 ? 28 : 64, background: "#fff", color: "#333", borderRadius: 8, padding: typeof window !== 'undefined' && window.innerWidth < 600 ? '0 8px' : '0 24px', minWidth: typeof window !== 'undefined' && window.innerWidth < 600 ? 40 : 90, textAlign: "center", fontFamily: "monospace", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>{time.days}</div>
            <div style={{ color: "#fff", marginTop: 8, fontSize: 20 }}>Days</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontSize: typeof window !== 'undefined' && window.innerWidth < 600 ? 28 : 64, background: "#fff", color: "#333", borderRadius: 8, padding: typeof window !== 'undefined' && window.innerWidth < 600 ? '0 8px' : '0 24px', minWidth: typeof window !== 'undefined' && window.innerWidth < 600 ? 40 : 90, textAlign: "center", fontFamily: "monospace", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>{time.hours}</div>
            <div style={{ color: "#fff", marginTop: 8, fontSize: 20 }}>Hours</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontSize: typeof window !== 'undefined' && window.innerWidth < 600 ? 28 : 64, background: "#fff", color: "#333", borderRadius: 8, padding: typeof window !== 'undefined' && window.innerWidth < 600 ? '0 8px' : '0 24px', minWidth: typeof window !== 'undefined' && window.innerWidth < 600 ? 40 : 90, textAlign: "center", fontFamily: "monospace", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>{time.minutes}</div>
            <div style={{ color: "#fff", marginTop: 8, fontSize: 20 }}>Minutes</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontSize: typeof window !== 'undefined' && window.innerWidth < 600 ? 28 : 64, background: "#fff", color: "#333", borderRadius: 8, padding: typeof window !== 'undefined' && window.innerWidth < 600 ? '0 8px' : '0 24px', minWidth: typeof window !== 'undefined' && window.innerWidth < 600 ? 40 : 90, textAlign: "center", fontFamily: "monospace", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>{time.seconds}</div>
        ...
        <div style={{ display: "flex", flexWrap: typeof window !== 'undefined' && window.innerWidth < 600 ? 'wrap' : 'nowrap', gap: typeof window !== 'undefined' && window.innerWidth < 600 ? 12 : 32, marginBottom: typeof window !== 'undefined' && window.innerWidth < 600 ? 8 : 16, justifyContent: 'center' }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontSize: typeof window !== 'undefined' && window.innerWidth < 600 ? 28 : 64, background: "#fff", color: "#333", borderRadius: 8, padding: typeof window !== 'undefined' && window.innerWidth < 600 ? '0 8px' : '0 24px', minWidth: typeof window !== 'undefined' && window.innerWidth < 600 ? 40 : 90, textAlign: "center", fontFamily: "monospace", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>{timeToBirthday.days}</div>
            <div style={{ color: "#fff", marginTop: 8, fontSize: 20 }}>Days</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontSize: typeof window !== 'undefined' && window.innerWidth < 600 ? 28 : 64, background: "#fff", color: "#333", borderRadius: 8, padding: typeof window !== 'undefined' && window.innerWidth < 600 ? '0 8px' : '0 24px', minWidth: typeof window !== 'undefined' && window.innerWidth < 600 ? 40 : 90, textAlign: "center", fontFamily: "monospace", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>{timeToBirthday.hours}</div>
            <div style={{ color: "#fff", marginTop: 8, fontSize: 20 }}>Hours</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontSize: typeof window !== 'undefined' && window.innerWidth < 600 ? 28 : 64, background: "#fff", color: "#333", borderRadius: 8, padding: typeof window !== 'undefined' && window.innerWidth < 600 ? '0 8px' : '0 24px', minWidth: typeof window !== 'undefined' && window.innerWidth < 600 ? 40 : 90, textAlign: "center", fontFamily: "monospace", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>{timeToBirthday.minutes}</div>
            <div style={{ color: "#fff", marginTop: 8, fontSize: 20 }}>Minutes</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontSize: typeof window !== 'undefined' && window.innerWidth < 600 ? 28 : 64, background: "#fff", color: "#333", borderRadius: 8, padding: typeof window !== 'undefined' && window.innerWidth < 600 ? '0 8px' : '0 24px', minWidth: typeof window !== 'undefined' && window.innerWidth < 600 ? 40 : 90, textAlign: "center", fontFamily: "monospace", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>{timeToBirthday.seconds}</div>
            <div style={{ color: "#fff", marginTop: 8, fontSize: 20 }}>Seconds</div>
          </div>
        </div>
      </div>
